  ...
  var loadMyCartEvent = function (userOptions) {
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<div class="modal-footer agregado" id="agregado">' +
    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          ...
          '<td class="text-center" style="width: 30px;"><img width="30px" height="30px" src="/build/' + this.image + '"/></td>' +
          '<td>' + this.name + '</td>' +
